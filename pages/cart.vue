                    ...
                    <FormKit type="form" @submit="handleSubmit">
                        ...
                        <ul>
                            <li class="flex">
                                ...
                                <span class="flex-1">{{ format(totalExclTax(), locale, 'USD') }}</span>
                            </li>
                            <li class="flex text-green-500">
                                <span class="flex-1">Discount</span>
                                <span class="flex-1">-{{ format(discount(totalExclTax()), locale, 'USD') }} ({{ discountRate * 100 }}%)</span>
                            </li>
                            <li class="flex">
                                <span class="flex-1">VAT</span>
                                <span class="flex-1">{{ format(vat(totalExclTax()), locale, 'USD') }} ({{ vatRate * 100 }}%)</span>
                            </li>
                            <li class="flex">
                                <span class="flex-1">Total</span>
                                <span class="flex-1">{{ format(totalInclTax(), locale, 'USD') }}</span>
                            </li>
                        </ul>
